...
function blob_fixup() {
    case "${1}" in
        vendor/bin/sensors.qti | vendor/lib64/libsnsapi.so | vendor/lib64/libsnsdiaglog.so | vendor/lib64/libssc.so | vendor/lib64/libwebrtc_audio_preprocessing.so | vendor/lib64/sensors.ssc.so)
